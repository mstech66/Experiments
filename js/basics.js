...
setTimeout(newStore.printStoreInfo, 1000); //this will print "" as it's late executed and hence garbage collection happened
...
//A live collection in JS is a collection of DOM Elements where changes to DOM are reflected in collection object

let liveList = document.getElementsByClassName("listitem");

console.log(`Length is ${liveList.length}`);

const newListItem = document.createElement("li");
newListItem.innerHTML = "Item 5";
